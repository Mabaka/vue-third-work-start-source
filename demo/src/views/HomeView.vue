            ...
            <div v-if="columns.length" class="desk__columns">
                <div v-for="column in columns" :key="column.id" class="column">
                    ...
                    <div class="column__target-area">
                        <!--            Задачи-->
                        <div v-for="task in columnTasks[column.id]" :key="column.id" class="column__task">
                            <div class="task">
                                <div v-if="task.user" class="task__user">
                                    <div class="task__avatar">
                                        <img :src="getImage(task.user.avatar)" :alt="task.user.name" width="20"
                                            height="20" />
                                    </div>
                                    {{ task.user.name }}
                                </div>
                                ...
                                <div class="task__statuses">
                                    ...
                                    <span v-if="task.timeStatus" class="task__status"
